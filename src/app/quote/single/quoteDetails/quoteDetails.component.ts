...
import {Quote, DevisDetail, BucketProduct, StatusQuotes,
  StatusQuotesInvoice,
...
export class QuoteDetailsComponent implements OnInit {
  ...
  //       // doc.text(110, verticalPointer, detail.priceWithQuantity.toString() );
  //       // doc.text(140, verticalPointer, detail.priceWithTaxesWithQuantity.toString() );
  //     });
  //
  //     doc.setFontSize(12);
  //     verticalPointer += 12
